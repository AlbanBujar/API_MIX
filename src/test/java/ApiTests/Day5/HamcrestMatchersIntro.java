...
public class HamcrestMatchersIntro {
    ...
    public void stringHamcrest(){
        ...
        assertThat(text,startsWithIgnoringCase("b22"));// buyuk yada kucuk oldugunun onemi yok text te odaklaniyor.
        //endswith
        ...
        //with ignoring case
        assertThat(text,containsStringIgnoringCase("LEARNING"));// buyuk yada kucuk oldugunun onemi yok text te odaklaniyor.
