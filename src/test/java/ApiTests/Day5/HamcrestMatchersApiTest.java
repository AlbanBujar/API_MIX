...
public class HamcrestMatchersApiTest {
    ...
    public void test1(){
        ...
        given().log().all().
                ...
                .and().pathParam("id",15)
                .when()
                .get("http://52.90.4.223:8000/api/spartans/{id}")
                .then()
                .statusCode(200)
                .and().assertThat()
    ...
    public void teacherData(){
        ...
        given()
                ...
                .when()
                .get("http://52.90.4.223:8000/teacher/{id}")
                .then()
                .statusCode(200)
                .and()
    ...
    public void teachersTest(){
        ...
        given()
                .accept(ContentType.JSON)
                .when()
                .get("http://api.cybertektraining.com/teacher/all") //"http://52.90.4.223:8000"
                .then()
                .statusCode(200)
                .and()
                .body("teachers.firstName",hasItems("Alexander","Darleen","Sean"));
        //check if this list hasItems 77,54,23 birden fazla oldugu icin hasItems
