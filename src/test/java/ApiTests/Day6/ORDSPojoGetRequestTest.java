...
import ApiTests.pojo.Employee;
import ApiTests.pojo.Region;
import ApiTests.pojo.Regions;
...
public class ORDSPojoGetRequestTest extends HRTestBase {
    ...
    @DisplayName("GET  request to /employees and only get couple of values as a Pojo")
    @Test
    public void employeeGet(){
        Employee employee1 = get("/employees").then().statusCode(200).extract()
                .jsonPath().getObject("items[0]", Employee.class);
